...
def reynolds_number(velocity: float, length: float, density: float,
...
def weber_number(density: float, velocity: float, length: float,
...
def bernoulli_velocity(P1: float, P2: float, z1: float, z2: float,
                      density: float, V1: float = 0,
...
def venturi_flow_rate(A1: float, A2: float, P1: float, P2: float,
                     density: float) -> float:
    """
...
def pitot_velocity(stagnation_pressure: float, static_pressure: float,
                  density: float) -> float:
    """
...
def terminal_velocity(mass: float, Cd: float, density: float, area: float,
                     g: float = 9.80665) -> float:
    """
...
def darcy_friction_factor_turbulent(Re: float, roughness: float,
...
def pipe_pressure_drop(f: float, length: float, diameter: float,
...
def head_loss(f: float, length: float, diameter: float, velocity: float,
             g: float = 9.80665) -> float:
    """
